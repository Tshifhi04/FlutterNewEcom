                      ...
                      child: SizedBox(
                          ...
                          child: Row(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(widget.singleProduct.name,style: const TextStyle(fontSize: 10.5, fontWeight: FontWeight.w500),),
                                 ...
                                 appProvider.removeFavouriteProduct(widget.singleProduct);
                                                               ...
                                                               },child: Text(  appProvider.getFavouriteProductList.contains(widget.singleProduct)?"Add to wishlist":"Remove from wishlist",style: const TextStyle(fontSize: 15.0, fontWeight: FontWeight.bold),)
                                                               ),
                       ...
                       appProvider.removeCartProduct(widget.singleProduct);
                        showMessage("Successfully removed from cart");
                            ...
                            Text("\R${widget.singleProduct.price.toString()}",style: const TextStyle(fontSize: 15.0, fontWeight: FontWeight.w400),),
                          ]),
